...
valac --vapidir=vapi/ --pkg sdl --pkg sdl-image --pkg gl --pkg glu --pkg glut -X -lSDL -X -lSDL_image -X -lglut src/main.vala src/scene.vala src/values.vala src/io.vala --Xcc=-I/usr/include/SDL
